...
var MoedaFacilWidget = React.createClass({
  ...
  componentDidMount: function(){
    ...
    var _this = this;
    var cb_name = 'MoedaFacilWidgetUpdate' + Date.now();
...
module.exports = MoedaFacilWidget;
